...
class Page extends Model
{
    ...
    protected $fillable = [
        ...
        'show_right_column', 'permission', 'location', 'visibility', 'show_breadcrumb', 'content','is_default',
    ];
    ...
    const LOCATION = [
        ...
        self::DONT_ADD_MENU => 'Dont Add Menu',
    ];

    public static function getMenuType(): array
    {
            $menuType[self::MAIN_MENU] = Lang::get('messages.page.'.self::MAIN_MENU);

            $menuType[self::DONT_ADD_MENU] = Lang::get('messages.page.'.self::DONT_ADD_MENU);
