...
class CustomPathGenerator implements PathGenerator
{
    public function getPath(Media $media): string
    {
        ...
        switch ($media->collection_name) {
            ...
            case User::COVER_IMG:
                return str_replace('{PARENT_DIR}', User::COVER_IMG, $path);
            case Setting::LOGO:
            ...
            case ReleaseListSetting::IMAGE_COLLECTION:
                return str_replace('{PARENT_DIR}', ReleaseListSetting::IMAGE_COLLECTION, $path);
            default:
                return '';
        }
    }
