                    ...
                    @foreach ($categoryPosts->take(5) as $post)
                        <div class="sm:flex mb-8">
                            <div
                                ...
                                <a href="{{ route('detailPage', $post->slug) }}" {{ getFrontSelectLanguageIsoCode() == 'ar' ? 'data-turbo=false' : '' }}>
                                ...
                                <div class="sm:pt-5 flex flex-wrap">
                                    ...
                                    <div class="flex flex-wrap sm:pt-0 pt-3 sm:pt-2">
                                        <div class="flex items-center mr-3">
                                            ...
                                            <span
                                                class="text-gray-200 sm:text-base text-sm font-medium">{{ $post->created_at->format('d') }}. {{ ucfirst(__('messages.common.' . strtolower($post->created_at->format('F')))) }} {{ $post->created_at->format('Y') }}</span>
                                        </div>
