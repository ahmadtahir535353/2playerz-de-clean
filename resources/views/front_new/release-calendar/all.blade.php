...
@section('content')
                            ...
                            <div class="release-calendar-page">
                                ...
                                <h3 class="text-black fw-7 fs-24 my-2">
                                    @if($setting && $setting->headline)
                                        {{ $setting->headline }}
                                    @else
                                        Alle bisher bekannten Spiele-Releases
                                    @endif
                                </h3>
                                ...
                                <!-- Author Info Row with Like/Comment/ReadTime (creator = user set in admin panel for this release list) -->
                                        ...
                                        @foreach($gamesWithDates as $year => $sections)
                                            ...
                                            @foreach($sections as $section)
                                                ...
                                                <ul class="release-list list-unstyled">
                                                    @foreach($section['games'] as $game)
                                                        @php
                                                            $onWishlist = in_array($game->id, $wishlistGameIds ?? []);
                                                        @endphp
    ...
    <style>
        ...
        .dark-mode .wishlist-login-modal .wishlist-login-title {
            color: #e5e5e5;
        }
        ...
        .dark-mode .wishlist-login-modal .wishlist-login-msg {
            color: #b0b0b0;
        }
        ...
        .dark-mode .wishlist-login-modal .wishlist-login-close {
            color: #999;
        }

        /* Wishlist info – bottom-right slide-out popup */
        .wishlist-info-popup {
            position: fixed;
            bottom: 20px;
            right: 20px;
        ...
        .wishlist-info-popup-close:hover {
            background: #ddd;
        }
        ...
        .dark-mode .wishlist-info-popup-content {
            color: #d0d0d0;
        }
    </style>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.wishlist-toggle').forEach(function(el) {
        el.addEventListener('click', function() {
            ...
            var onWishlist = this.getAttribute('data-on-wishlist') === '1';
            var toggle = this;
