                                    ...
                                    <div class="col-xl-4 col-5 card-top">
                                        <div class="card-img-top">
                                            <a href="{{ route('detailPage', $news['slug']) }}">
                                                {{--                                            <img data-src="{{ $news['post_image'] }}" alt="{{ $news['title'] }}" src="{{ asset('front_web/images/bg-process.png') }}" class="w-100 h-100 w-300px lazy"> --}}
...
<section class="action-buttons-section py-60">
    <div class="d-flex flex-column gap-3">
        <a href="{{ route('contact.index') }}" 
           class="btn w-100 px-3 py-2 text-center text-white fw-6 rounded"
           style="background-color: #734E96; border: none; text-decoration: none;">
