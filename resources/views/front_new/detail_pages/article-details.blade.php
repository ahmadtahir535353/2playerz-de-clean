...
@endpush
@push('preload')
@if(!empty($postDetail->post_image))
<link rel="preload" as="image" href="{{ $postDetail->post_image }}" fetchpriority="high">
@endif
@endpush
@section('pageCss')
...
<style>
    /* LCP Image Optimization - Prevent Layout Shift */
    .news-details-img {
        aspect-ratio: 16 / 9;
        min-height: 400px;
...
<style>
    ...
    .article-action-btn[title]:hover::before,
    .comment-btn-wrapper[title]:hover::before {
        content: '';
        position: absolute;
        bottom: 100%;
        left: 50%;
                    ...
                    <section class="news-details-left pe-xxl-3">
                        <div class="news-details">
                                    ...
                                    <div class="d-flex">
                                        <div class="">
                                            ...
                                            <a href="{{ $authorProfileUrl }}"
                                                class="profile-link"
                                                data-user-identifier="{{ $authorUsername }}">
                            ...
                            <div class="news-desc mb-20 video-content">
                                @php
                                    $html = $postDetail->postArticle->article_content ?? '';
                        ...
                        <!-- news card -->
                        <!-- <div class="card d-flex flex-row p-2 border border-secondary w-100" style="    border-radius: 10px !important;
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (newsDesc) {
            ...
            imageElements.forEach((img, index) => {
                // Add copyright text if data-copyright attribute exists (content images only)
