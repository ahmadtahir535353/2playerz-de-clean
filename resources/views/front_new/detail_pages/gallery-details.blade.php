                        ...
                        <div class="news-details">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex justify-content-start flex-column">
                                            <a
                                                ...
                                                <span
                                                    class="fs-12 text-gray">{{ $postDetail->created_at->format('d') }}. {{ ucfirst(__('messages.common.' . strtolower($postDetail->created_at->format('F')))) }} {{ $postDetail->created_at->format('Y') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-5">
                                    <div class="news-text mb-2 d-flex justify-content-around" style="gap: 10px">
                                        <div class="desc d-inline-block">
                                            <a href="#commentFormSection" class="text-gray">
                            ...
                            <div class="news-desc mb-20 position-relative mt-4">
                                ...
                                <h3 class="text-black fw-7 fs-20">
                                    {{ $galleryPostNo }}.{{ $galleryPost->gallery_title }}
                                </h3>
                                ...
                                <div class="news-desc mb-20 position-relative mt-4">
                                    ...
                                    <div class="post-body video-content">
                                        <p>
                                            @if (isset($galleryPost->gallery_content))
                                            {!! $galleryPost->gallery_content !!}
                                            @endif
                                ...
                                <div class="comment-view" {{ $totalComments >= 3 ? $inStyle . '' : '' }}>
                                    ...
                                    <div class="media d-flex card-view-{{ $comment->id }}">
                                        <div
                                            ...
                                            <img
                                                src="{{ isset($comment->users->profile_image) ? $comment->users->profile_image : asset('web/media/avatars/150-2.jpg') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <textarea class="form-control fs-14 text-gray" name="comment" id="comment"
                                                rows="3"
                                                style="color:rgb(123, 123, 123) !important"
