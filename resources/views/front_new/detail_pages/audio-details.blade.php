        ...
        <div class="container">
            <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <section class="share-this-post-section">
                                            ...
                                            <div id="white-player-center">
                                                ...
                                                <div class="time-progress" dir="ltr">
                                            ...
                                            <div id="white-player-controls" dir="ltr">
                ...
                <section class="share-this-post-section mt-2 pt-md-3">
                    ...
                    <section class="post-comment-section bg-light px-30 py-4" style="box-shadow: 0px 0px 10px #00000020; border-radius: 15px;" id="commentFormSection">
                            ...
                            <div class="col-md-6 ">
                                ...
                                <div class="card d-flex flex-row mb-40">
                                    ...
                                    <div
                                        ...
                                        <span
                                            class=" fs-14 text-gray">{{ $nextPost['created_at']->format('d, Y') }}. {{ ucfirst(__('messages.common.' . strtolower($nextPost['created_at']->format('M')))) }}
                                ...
                                <p class="fs-14 text-gray mt-1 comment-msg">
                                    ...
                                    <span class="like-btn"
                                        ...
                                        <i class="fa fa-thumbs-up"
                                            style="color: {{ $comment->user_liked ? '#B051B0' : 'gray' }};"></i>
                                        <span style="color: #000;" class="like-count">{{ $comment->likes_count }}</span>
                                    </span>
                                </p>
                            </div>
                        </div>
