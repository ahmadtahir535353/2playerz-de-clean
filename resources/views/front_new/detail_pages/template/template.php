...
<div class="media d-flex card-view-{{:id}} mt-2">
    ...
    <div class="media-body comment-content w-100">
        <div class="media-title d-flex flex-wrap justify-content-between">
            ...
            <button class="delete-btn fs-14 text-danger delete-comment-btn" data-id="{{:id}}"><i class="fa fa-trash-can px-1"></i><?php echo __('messages.delete') ?></button>
        </div>
        <span class="text-gray fs-14 reply-time">{{:commentCreated}}</span>
