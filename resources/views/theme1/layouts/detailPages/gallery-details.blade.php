                                            ...
                                            @foreach ($emojis as $emoji)
                                                <a href="javascript:void(0);" class="flex flex-col items-center px-1.5">
                                                    <div class="text-4xl relative emoji-id"
                                                        ...
                                                        <span
                                                            class="bg-black {{ getFrontSelectLanguageIsoCode() == 'ar' ? 'p-0' : '' }} rounded-full text-white text-[10px] absolute -top-1 -right-1 w-4 h-4 flex justify-center items-center post-reaction-count  like-reaction p-0"
                            ...
                            @if (getSettingValue()['facebook'] ||
                                ...
                                <div @click.away="open = false" x-data="{ open: false }">
                                    ...
                                    <div :class="{ 'showpopup': open, 'hidden': !open }"
                                        ...
                                        <div class="flex gap-3 popup-scrollbar overflow-auto">
                                            @if (getSettingValue()['facebook'])
                                                <a href="https://www.facebook.com/sharer.php?u={{ getUrl() }}"
                                                    class="bg-blue-600 p-1.5 rounded-lg flex justify-center items-center">
                                            ...
                                            @if (getSettingValue()['twitter'])
                                                <a href="https://www.twitter.com/share?url={{ getUrl() }}"
                                                    class="bg-sky-400 p-1.5 rounded-lg flex justify-center items-center">
                                            ...
                                            @if (getSettingValue()['linkedin'])
                                                <a href="https://www.linkedin.com/shareArticle?mini=true&url={{ getUrl() }}"
                                                    class="bg-sky-600 p-1.5 rounded-lg flex justify-center items-center">
                                            ...
                                            @if (getSettingValue()['reddit'])
                                                <a href="https://reddit.com/submit?url={{ getUrl() }}"
                                                    class="p-1.5 rounded-lg flex justify-center items-center"
