                ...
                <ol class="list-none p-0 inline-flex flex-wrap">
                    ...
                    <li class="flex items-center">
                        <a href="{{ route('categoryPage', $postDetail->category->name) }}"
                            class="text-gray-300 text-sm font-medium ms-2 category-name">{!! $postDetail->category->name !!}</a>
        ...
        <div class="container mx-auto max-w-7xl xl:px-0 lg:px-10 md:px-8 px-4">
            <div class="">
                ...
                <div class="sm:pt-5 flex flex-wrap">
                    @php
                        $authorUsername = optional($postDetail->user)->username;
                        $authorProfileUrl = $authorUsername ? route('user.public.profile', $authorUsername) : '#';
                    @endphp
                    <div
            ...
            <div class="lg:grid lg:grid-cols-3 pt-10 gap-8">
                <div class="col-span-2 sm:mb-0 mb-10">
                    ...
                    <div class="mb-10">
                        <p class="sm:text-lg text-base text-justify break-all news-desc">
                                ...
                                <div @click.away="open = false" x-data="{ open: false }">
                                    <div class="relative flex flex-col items-center group">
                                        ...
                                        <div
                                            ...
                                            <span
                                                class="relative z-10 p-2 text-xs leading-none text-white whitespace-no-wrap bg-black shadow-lg">{{ __('messages.share') }}</span>
                                            <div class="w-3 h-3 -mt-2 rotate-45 bg-black"></div>
                                        </div>
                                    </div>
                                    <div :class="{ 'showpopup': open, 'hidden': !open }"
                    ...
                    <div class="lg:pt-20 md:pt-14 xs:pt-12 pt-10">
                        <div class="container container max-w-7xl xl:px-0 lg:px-10 md:px-8">
                        ...
                        <div class="max-h-[250px] custom-scrollbar overflow-auto justify-between comment-view">
                            @foreach ($comments as $comment)
                                <div class="xs:flex flex sm:flex card-view-{{ $comment->id }} border-b py-5">
                                    <div class="flex">
                                        <div
                                            class="w-20 h-20 min-w-[80px] rounded-full overflow-hidden xs:mr-5 mr-5 xs:mb-0 mb-4">
                                        ...
                                        <div class="">
                                            ...
                                            <span class="like-btn"
                                                        ...
                                                        <i class="fa fa-thumbs-up" id="current_like_icon_{{ $comment->id }}" style="color: {{ $comment->user_liked ? 'aqua' : 'gray' }};"></i>
                                                        <span style="color: #000; margin-left: 4px;" class="like-count">{{ $comment->likes_count }}</span>
                                                </span>
                                        </div>
                                    </div>
