                    ...
                    <div class="sm:flex justify-between items-center relative">
                        ...
                        <div class="flex gap-6 px-2 sm:pt-0 pt-4">
                                            ...
                                            @foreach ($emojis as $emoji)
                                                <a href="javascript:void(0);" class="flex flex-col items-center px-1.5">
                                                    <div class="text-4xl relative emoji-id"
                                                        ...
                                                        <span
                                                            class="bg-black rounded-full {{ getFrontSelectLanguageIsoCode() == 'ar' ? 'p-0' : '' }} text-white text-[10px] absolute -top-1 -right-1 w-4 h-4 flex justify-center items-center post-reaction-count  like-reaction"
                            ...
                            <div class="relative flex flex-col items-center group">
                                ...
                                <div class="absolute bottom-0 flex flex-col items-center hidden mb-6 group-hover:flex">
                                    <span
                                        class="relative z-10 p-2 text-xs leading-none text-white whitespace-no-wrap bg-black shadow-lg">Comment</span>
                                    <div class="w-3 h-3 -mt-2 rotate-45 bg-black"></div>
                                </div>
                            </div>
                                ...
                                <div class="w-full h-[215px] rounded-lg overflow-hidden relative">
                                    ...
                                    <a href="{{ route('detailPage', $relatedPost->slug) }}">
                                        ...
                                        @elseif($relatedPost['post_types'] == \App\Models\Post::VIDEO_TYPE_ACTIVE)
                                            @php
                                                $thumbUrl =
                                                    !empty($relatedPost['postVideo']) &&
                                                    !empty($relatedPost['postVideo']->thumbnail_image_url)
                                                        ? $relatedPost['postVideo']->thumbnail_image_url
                                                        : null;
                                                $thumbImage =
                                                    !empty($relatedPost['postVideo']) &&
                                                    !empty($relatedPost['postVideo']->uploaded_thumb)
                                                        ? $relatedPost['postVideo']->uploaded_thumb
